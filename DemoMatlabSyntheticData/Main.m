...
stp = 2; % downsampling number of spectral bands 
...
[X_NDU2, F_NDU2, t_NDU2, K_NDU2] = NDU_CG(S,R,V,lambda,mu,par,str);
...
disp(strcat('NDU: ',num2str(RMSE_X_NDU2),' ; ',num2str(RMSE_F_NDU2))); 
